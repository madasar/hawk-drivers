...
/**
 * This interface represents a project session. A modeling session is used to update a modelio project and to give the
 * right model navigation roots.
 * <p>
 * <p>
...
public interface IModelingSession {
     ...
     * {@link IModelChangeHandler} listener class.
     ...
     * <p>
     * This model listener is used to be notified of the model structural changes, through the use of the
     * {@link IModelChangeListener} listener class.
     ...
     * {@link IStatusChangeHandler} listener class.
     * @param handler the model change listener to add.
     */
    @objid ("785d1e17-f797-11dd-83f5-0014222a9f79")
    void addStatusHandler(IStatusChangeHandler handler);
     ...
     * {@link IStatusChangeListener} listener class.
     * @param listener the model change listener to add.
     */
     ...
     * the use of this method, and Committed via the {@link #commit(ITransaction)} method or rollbacked using the
     * {@link #rollback(ITransaction)} method.
     * @param transactionName A transaction name. This name is just a label that might be displayed in log files, a console or
     * dialog boxes.
    ...
    /**
     * Get an element in the model from its metaclass, a meta attribute name and value .<br>
    ...
    /**
     * Get all elements in the model from their metaclass.<br>
     * If "element" is given, every model elements will be returned.
     * @param metaclass the metaclass to look for.
    ...
    /**
     * Get an element in the model from its id and metaclass.<br>
     * If "element" is given, every model elements will be checked.
     * @param metaclass the metaclass to look for.
     ...
     * <p>
     * <p>
     * The metamodel extensions are added by the tool when modules are deployed. It corresponds to the stereotypes, note
     * types and tag types brought by modules.
     ...
     * <p>
     * <p>
     * This method is often used to get the root package using the {@link IUmlModel#getRoot()} method
     ...
     * <p>
     * <p>
     * The requirement model owns three model roots: the requirement container, the dictionary and the requirement
     * administration models.
     * @return the Requirement Model connected to the session.
     */
     ...
     * @param handler the status change handler to remove.
     */
    @objid ("7db5a3e8-f797-11dd-83f5-0014222a9f79")
    void removeStatusHandler(IStatusChangeHandler handler);

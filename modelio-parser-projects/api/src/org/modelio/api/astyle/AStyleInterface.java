...
class AStyleInterface {
    ...
    public String formatSource(final String textIn, final String options) {
        ...
        try {
            ...
            Modelio.getInstance().getLogService().warning(null,
                                                          "Cannot call function AStyleMain - " +
                                                                  e.getMessage());
            textOut = "";
        }
        return textOut;
    ...
    public String getVersion() {
        ...
        try {
            ...
            Modelio.getInstance().getLogService().warning(null, "Cannot call function GetVersion");
            version = "";
        }
        return version;
    }
    ...
    public void ErrorHandler(final int id, final String str) {
        Modelio.getInstance().getLogService().error(null,str);
    }

 ...
 * <li> {@link IModelComponentService#deployModelComponent(File, IProgressMonitor)}: deploy a model component from a file.</li>
 * <li> {@link IModelComponentService#removeModelComponent(IModelComponentDescriptor)}: remove a model component from the model.</li>
 * <li> {@link IModelComponentService#getModelComponents()}: get the list of all model components deployed in the model.</li>
 * <li> {@link IModelComponentService#packageModelComponent(Artifact, Set, File, IProgressMonitor)}: package a new model component file from a model.</li>
 */
...
public interface IModelComponentService {
     ...
     * Modules might contribute to a model component, adding model extensions (notes, tagged values, stereotypes) and/or files to it.<br>

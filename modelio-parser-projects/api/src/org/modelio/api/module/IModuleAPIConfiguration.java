...
public interface IModuleAPIConfiguration {
    ...
    /**
     * Get the directory where the project is located. This directory can be used as the root directory where generation
     * modules output files.
     * @return the project space path
     */
    @objid ("d034940a-cce7-11dd-8617-001ec947ccaf")

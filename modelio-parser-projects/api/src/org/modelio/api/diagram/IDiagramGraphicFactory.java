...
public interface IDiagramGraphicFactory {
    ...
    IDiagramNode createDrawingEllipse(IDiagramDrawingsLayer layer, String drawingIdentifier, int x, int y, int w, int h);
    ...
    IDiagramNode createDrawingText(IDiagramDrawingsLayer layer, String drawingIdentifier, String label, int x, int y, int w, int h);
    ...
    IDiagramLink createDrawingLine(IDiagramDrawingsLayer layer, String drawingIdentifier, int x, int y, int x2, int y2);

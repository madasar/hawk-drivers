 ...
 * activate the undo/redo mechanism. It is also possible to rollback a transaction and empty the transaction stacks (usually after
 * saving the model).
 */
...
public class TransactionManager implements IActionManager, ITransactionSupport {
    ...
    private SyncSupport sync = new SyncSupport();

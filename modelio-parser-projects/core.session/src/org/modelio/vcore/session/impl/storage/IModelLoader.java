...
public interface IModelLoader extends AutoCloseable {
    ...
    SmObjectImpl createLoadedObject(final SmClass classof, final UUID id) throws DuplicateObjectException;
    ...
    SmObjectImpl loadForeignObject(final SmClass classof, final UUID id, final String name);
    ...
    SmObjectImpl createLoadedObject(SmClass cls, UUID uuid, SmObjectData d) throws DuplicateObjectException;

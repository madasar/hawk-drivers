...
public class CacheHandle implements ICacheHandle {
    ...
    @objid ("005b3d3a-e8e6-1f34-b94f-001ec947cd2a")
    @Override
    public Collection<SmObjectImpl> getInstances(final SmClass cls) {
        Collection<SmObjectImpl> res = new ArrayList<>();
        this.cacheManager.findByClass(cls, res );
        return res;
    }

...
class AccessManagerModelLoader implements IModelLoader {
    ...
    @Override
    public SmObjectImpl loadForeignObject(SmClass classof, UUID id, String name) {
        throw Unsupported();
    }
    ...
    public void loadAttribute(SmObjectImpl obj, SmAttribute att, Object newValue) {
        ...
        assert (att == SmObjectData.Metadata.statusAtt()) : att + " is not the status attribute.";
    ...
    @Override
    public SmObjectImpl createLoadedObject(SmClass cls, UUID uuid, SmObjectData d) throws DuplicateObjectException {
        throw Unsupported();
    }

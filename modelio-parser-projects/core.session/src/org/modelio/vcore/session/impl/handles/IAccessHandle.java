...
public interface IAccessHandle {
     ...
     * @return <code>true</code> if the source object is modifiable, <code>false</code> if it is not modifiable but the dependency modification
     * is allowed.
    ...
    boolean checkAccessFor(final SmObjectImpl obj, final SmDependency dep, final SmObjectImpl val) throws AccessDeniedException;
     ...
     * @param val the object to append or remove to the dependency
     * @return <code>true</code> if the source object is modifiable, <code>false</code> if it is not modifiable but the attribute modification
     * is allowed.
     * @throws org.modelio.vcore.smkernel.AccessDeniedException if the modification is denied.
     */
    @objid ("8cb387a0-283b-4a98-b2eb-f7783e65b469")
    boolean checkAccessFor(SmObjectImpl obj, SmAttribute att, SmObjectImpl val) throws AccessDeniedException;

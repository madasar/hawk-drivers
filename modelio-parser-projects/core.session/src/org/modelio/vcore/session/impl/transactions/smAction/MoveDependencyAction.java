...
public class MoveDependencyAction extends DependencyModificationAction {
    /**
     * Remet l'objet ? son ancienne place dans l'association. L'action est
    ...
    public void undo(final boolean rollback) {
        // On remet l'objet ? son ancienne place dans la dependance
        this.smDep.moveRef(this.refered, this.ref, -this.index);
    }
    ...
    /**
     * Deplace un objet dans une dependance. Sauvegarde l'objet contenant la

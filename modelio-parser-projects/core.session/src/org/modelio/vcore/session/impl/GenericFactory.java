...
public final class GenericFactory {
    ...
    GenericFactory(SmFactory smFactory, IRepositorySupport repoSupport) {
     ...
     * <p>
     * The new object will belong to the same
    ...
    /**
     * Create an instance of 'metaclass' and define 'parent' as its composition
     * owner using the dependency 'dep'.
     * <p>
     * The new object will belong to the same
     * repository as the 'parent' object.
    ...
    /**
     * Create an instance of 'metaclass' and define 'parent' as its composition
     * owner using the dependency 'dep'. The new object will belong to the same
     * repository as the 'parent' object.
    ...
    public <T extends MObject> T create(Class<T> metaclass, IRepository repository) {
        return (T) this.smFactory.createObject(SmClass.getClass(metaclass), repository);
    }

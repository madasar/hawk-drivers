...
public interface IRepository {
    ...
    Collection<MObject> findByAtt(final SmClass cls, final String att, final Object val);
    ...
    Collection<MObject> findByClass(final SmClass cls);

    /**
     * Find a model object by identifier.
     * @param cls a model class.
     * @param siteIdentifier the object unique UUID.

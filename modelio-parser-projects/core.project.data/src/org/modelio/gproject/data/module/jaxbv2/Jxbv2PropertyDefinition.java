...
public class Jxbv2PropertyDefinition {
    ...
    @objid ("49b98049-f2c7-4f8b-8f41-b48675413579")
     ...
     * @return
     * possible object is
     * {@link Jxbv2PropertyDefinition.Jxbv2TypeRef }
     */
     ...
     * </pre>
     */
    @objid ("7eade27c-43cd-4f72-83b1-b7cdf55f11de")
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Jxbv2TypeRef {
        @objid ("6d1ca469-dd90-42e9-ab8e-a688c20b34fa")
        @XmlAttribute(name = "id", required = true)
        protected String id;
         ...
         * {@link String }
         */
        @objid ("9a7c633b-6c40-431d-89b1-c7ab184d38ad")
        public String getId() {
            return this.id;
        }
         ...
         * {@link String }
         */
        @objid ("a2cf5166-2f75-4294-a54c-de0a589f4649")
        public void setId(String value) {
            this.id = value;
        }

...
public class DeadObjectException extends IllegalStateException {
    ...
    @objid ("84ef656b-dafb-4b26-81b7-c9b27e93c707")
    @Override
    public String getMessage() {
        return this.deadObj.getUuid().toString() + this.deadObj.getMClass().getName() + " is a dead object and cannot be used anymore.";
    }

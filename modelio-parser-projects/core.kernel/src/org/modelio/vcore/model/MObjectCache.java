...
public class MObjectCache {
    ...
    public void findByAtt(final MClass cls, final String att, Object val, final Collection<MObject> results) {
    ...
    public void findByClass(MClass cls, Collection<? super SmObjectImpl> result) {
        // The search is first done for the metaclass itself
    ...
    private static class MClassCache extends ConcurrentHashMap<UUID,SmObjectImpl> implements IMClassCache {
...
// nothing more
    ...
    private static class EmptyClassCache extends AbstractMap<UUID,SmObjectImpl> implements IMClassCache {
        ...
        @Override
        public Set<java.util.Map.Entry<UUID,SmObjectImpl>> entrySet() {
            return Collections.emptySet();
        }

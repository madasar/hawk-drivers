...
public class VersionedNodeDependencies {
    ...
    private Set<MObject> compManagedNodes = new TreeSet<>(MObjectComparator.instance);

    @objid ("3de29127-121a-11e2-816a-001ec947ccaf")
    private Set<MObject> refNodes = new TreeSet<>(MObjectComparator.instance);

    @objid ("3de29128-121a-11e2-816a-001ec947ccaf")
    private Set<MObject> refDeps = new TreeSet<>(MObjectComparator.instance);

    @objid ("3de29129-121a-11e2-816a-001ec947ccaf")
    private MObject parentNode;
    ...
    private Set<MObject> extDeps = new TreeSet<>(MObjectComparator.instance);

    @objid ("4c07a284-1224-11e2-816a-001ec947ccaf")
    private Set<MObject> compLocalNodes = new TreeSet<>(MObjectComparator.instance);

...
/**
 * Abstract implementation of {@link SmDependencyTypeChecker}, providing two methods:
 * The {@link AbstractDependencyTypeChecker#register(String, String)} method must be called to declare the checker on the appropriate {@link SmDependency}.
 * The {@link AbstractDependencyTypeChecker#doCheck(SmObjectImpl, SmObjectImpl)} method must be implemented with the checker behavior.
 */
...
public abstract class AbstractDependencyTypeChecker implements SmDependencyTypeChecker {
    ...
    protected void register(final String metaclass, final String feature) {
        SmClass mc = SmClass.getClass(metaclass);

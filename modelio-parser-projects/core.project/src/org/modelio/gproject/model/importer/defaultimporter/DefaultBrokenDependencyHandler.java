...
import org.modelio.gproject.model.importer.core.IBrokenDepReport;
...
public class DefaultBrokenDependencyHandler implements IBrokenDependencyHandler {
    ...
    public void handleBrokenDep(IBrokenDepReport brokenDepReport) {
        ...
        // FIXME log error
        System.err.printf(" '%s' %s missing, needed by '%s' %s on '%s' dependency", GetAbsoluteSymbol.get(missingrRefObject), missingrRefObject

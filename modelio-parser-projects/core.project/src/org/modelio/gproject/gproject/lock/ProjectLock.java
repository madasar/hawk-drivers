...
public class ProjectLock {
    ...
    /**
     * Acquires the lock.
     * @throws org.modelio.gproject.gproject.GProjectLockedException if the project is already open somewhere else.
     * @throws java.io.IOException in case of I/O failure
     * @throws java.lang.IllegalStateException if this lock instance is already acquired
     */
    @objid ("709d2133-0d55-4318-a2c8-c06f58ceccd0")
    public synchronized void lock() throws GProjectLockedException, IOException, IllegalStateException {
        if (this.lock != null || this.channel != null)
            throw new IllegalStateException(CoreProject.getMessage("ProjectLock.sameVm", this.projectName));

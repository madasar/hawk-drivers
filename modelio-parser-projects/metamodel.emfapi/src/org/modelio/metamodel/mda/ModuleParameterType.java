...
public enum ModuleParameterType implements Enumerator {
    ...
    TYPE_PARAM_FILE_OPEN (3, "TYPE_PARAM_FILE_OPEN", "TYPE_PARAM_FILE_OPEN"),
    TYPE_PARAM_FILE_SAVE (4, "TYPE_PARAM_FILE_SAVE", "TYPE_PARAM_FILE_SAVE"),
...
public static final int TYPE_PARAM_FILE_OPEN_VALUE = 3;
public static final int TYPE_PARAM_FILE_SAVE_VALUE = 4;
...
TYPE_PARAM_STRING,
TYPE_PARAM_ENUM,
TYPE_PARAM_FILE_OPEN,
TYPE_PARAM_FILE_SAVE,
...
public static ModuleParameterType get(int value) {
    switch (value) {
        ...
        case TYPE_PARAM_FILE_OPEN_VALUE: return TYPE_PARAM_FILE_OPEN;
        case TYPE_PARAM_FILE_SAVE_VALUE: return TYPE_PARAM_FILE_SAVE;

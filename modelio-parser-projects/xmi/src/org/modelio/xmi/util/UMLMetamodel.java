    ...
    private Model load(final URI uriModel) {
        ...
        try {
            ...
            if (bundle!=null){
            	...
            	uriLibraries = URI.createURI(FileLocator.find(bundle, libraries, null).toExternalForm());
            	uriMetamodels = URI.createURI(FileLocator.find(bundle, metamodels, null).toExternalForm());
            	uriProfiles = URI.createURI(FileLocator.find(bundle, profile, null).toExternalForm());
            }
            else{
            	
            	//non OSGi mode/standalone
            	...
            	uriLibraries = uri.appendSegment("libraries").appendSegment("");
            	uriMetamodels = uri.appendSegment("metamodels").appendSegment("");
            	uriProfiles = uri.appendSegment("profiles").appendSegment("");
            }
            ...
            resoureSet.getPackageRegistry().put(org.eclipse.uml2.uml.UMLPackage.eNS_URI,

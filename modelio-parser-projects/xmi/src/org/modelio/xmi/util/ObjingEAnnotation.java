...
public class ObjingEAnnotation extends XMIEAnnotation {
    ...
    public static boolean hasObjingID(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isPrimitive(org.eclipse.uml2.uml.Element ecoreElt) {
        return getBooleanContent(ecoreElt, IS_ELEMENTARY);
    }

    @objid ("ae48b0cb-2131-4efb-9fe0-36bf749caac7")
    public static boolean isProvidedInterface(org.eclipse.uml2.uml.Element ecoreElt) {
        return getBooleanContent(ecoreElt, IS_PROVIDED_INTERFACE);
    }

    @objid ("e43432ff-8242-45d6-9d2b-e087ac6db3b3")
    public static boolean isRequiredInterface(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isNavigable(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isUndefined(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isConstant(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isEvent(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isReentrant(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isException(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isIsOrdered(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isIsUnique(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isDefaultStereotype(org.eclipse.uml2.uml.Stereotype ecoreElt) {
    ...
    public static boolean isInstantiable(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isLeaf(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isLink(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isRoot(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isConnector(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isBindableInstance(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isBase(org.eclipse.uml2.uml.Element ecoreElt) {
        return getBooleanContent(ecoreElt, IS_BASE);
    }

    @objid ("36a94d4e-a082-4238-9248-b2dd0cbe8ba3")
    public static boolean isBehavior(org.eclipse.uml2.uml.Element ecoreElt) {
        return getBooleanContent(ecoreElt, IS_BEHAVIOR);
    }

    @objid ("e48714dd-bb3f-4515-b1e8-6072232699a8")
    public static boolean isService(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isPBase(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isDeleted(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isRepresentation(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isOBase(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isPort(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isNoType(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getTypeConstraint(org.eclipse.uml2.uml.Element ecoreElt) {
        return getEAnnotationContent(ecoreElt, OBJING_NAME, TYPE_CONSTRAINT);
    }

    @objid ("db518680-9754-476c-8778-87313ec10ac5")
    public static String getTagType(org.eclipse.uml2.uml.Element ecoreElt) {
        return getEAnnotationContent(ecoreElt, OBJING_NAME, TAGTYPE);
    }

    @objid ("c5ed5246-e372-46fb-84b8-310054d5d973")
    public static String getTaggedValue(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getMultiMin(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getType(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getMultiMax(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isDynamicDependency(org.eclipse.uml2.uml.Element ecoreElt) {
        return getBooleanContent(ecoreElt, IS_DERIVED);
    }

    @objid ("b2bb7d29-3cac-4d23-9073-3b8350bff2a3")
    public static boolean isMain(org.eclipse.uml2.uml.Element ecoreElt) {
        return getBooleanContent(ecoreElt, IS_MAIN);
    }

    @objid ("a2d83ad9-6438-4338-80c9-bc732a908380")
    public static boolean isTagParameter(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isIsAbstract(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getAccessMode(org.eclipse.uml2.uml.Element ecoreElt) {
        return getAndDestroyEAnnotationContent(ecoreElt, OBJING_NAME, ACCESS_MODE);
    }

    @objid ("1f8acf07-6098-4a19-b17f-b346fb45c455")
    public static EAnnotation getOrCreateObjingEAnnotation(org.eclipse.uml2.uml.Element ecoreElt) {
        EAnnotation ea = null;
        if (genProp.isRoundtripEnabled()) {
    ...
    public static String getDiscriminator(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getImportedElement(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getJoinSpec(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isCombineDuplicate(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isConcurrent(org.eclipse.uml2.uml.Element ecoreElt) {
        return getBooleanContent(ecoreElt, IS_CONCURRENT);
    }

    @objid ("d2c9fd02-1839-4336-a78a-54d33d95830e")
    public static boolean isStereotyped(org.eclipse.uml2.uml.Element ecoreElt) {
        return getBooleanContent(ecoreElt, STEREOTYPE);
    }

    @objid ("d6684f0b-fb4e-4cad-90d0-aee340ca6d1d")
    public static boolean isCreate(org.eclipse.uml2.uml.Element ecoreElt) {
        return getBooleanContent(ecoreElt, IS_CREATE);
    }

    @objid ("c353e940-4798-46c3-bb75-abfb5b1b7dfe")
    public static boolean isDestroy(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isTargetIsClass(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getEffect(org.eclipse.uml2.uml.Element flow) {
    ...
    public static String getValue(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static int getVisibility(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isExpansion(org.eclipse.uml2.uml.Pin pin) {
    ...
    public static boolean isFlow(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getPostCondition(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getSignal(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getReceivedEvent(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isAttributeLink(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getIconType(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getLabel(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isHidden(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isPartSignature(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isReference(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static void setModule(org.eclipse.uml2.uml.Profile ecoreElt, String module) {
        setOrCreateEAnnotationContent(ecoreElt, OBJING_NAME, MODULE, module);
    }

    @objid ("17a32bb4-fd75-44f1-98d5-9a72132693e7")
    public static String getModule(org.eclipse.uml2.uml.Element ecoreElt) {
        return getEAnnotationContent(ecoreElt, OBJING_NAME, MODULE);
    }

    @objid ("68729e21-2dbd-4a8d-b386-9aed4824b291")
    public static void alwaysSetOwner(org.eclipse.uml2.uml.Element ecoreElt, String ownerId) {
        setOrCreateEAnnotationContent(ecoreElt, OBJING_NAME,
                OWNER, ownerId);
    }

    @objid ("12701b71-f126-44a1-a913-621b24c7bffb")
    public static void deleteOwner(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isValueParameter(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static boolean isNoteType(org.eclipse.uml2.uml.Element ecoreElt) {
        return getBooleanContent(ecoreElt, IS_NOTETYPE);
    }

    @objid ("b718304c-8c2d-4ef4-bc6c-652cd0216f81")
    public static String getObjingEAnnotation(org.eclipse.uml2.uml.Element ecoreElt, String name) {
        return getEAnnotationContent(ecoreElt, OBJING_NAME,name);
    }

    @objid ("65caff19-e84f-4cd5-806f-c69c0d7e0be5")
    public static String getStereotype(org.eclipse.uml2.uml.Element ecoreElt) {
        return getEAnnotationContent(ecoreElt, OBJING_NAME, STEREOTYPE);
    }

    @objid ("e422123a-7916-4de5-93f3-14e66dd4784c")
    public static void setNamedWithConvention(org.eclipse.uml2.uml.Stereotype ecoreElt, boolean isNamedWithConvention) {
    ...
    public static boolean isNamedWithConvention(org.eclipse.uml2.uml.Stereotype ecoreElt) {
    ...
    public static void setEcoreId(org.eclipse.uml2.uml.Element ecoreElt, String ecoreId) {
        setOrCreateEAnnotationContent(ecoreElt, OBJING_NAME,
                ECOREID, ecoreId);
    }

    @objid ("148314bb-d11a-49cc-8a12-884653ce58fb")
    public static String getEcoreId(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static String getDiagramName(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static int getEndLineNumber(org.eclipse.uml2.uml.Element ecoreElt) {
    ...
    public static void setUUId(org.eclipse.uml2.uml.Element ecoreElt, String identifier) {
        setOrCreateEAnnotationContent(ecoreElt, OBJING_NAME,
                UUID, identifier);
    }

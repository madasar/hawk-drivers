...
public class OComponentRealization extends OModelElement {
    @objid ("04da492a-3dfd-4ee3-8077-79845448e5a9")
    private ComponentRealization objingElement = null;
    ...
    public void attach(org.eclipse.uml2.uml.Element ecoreElt) {
        ...
        Component objingComp = this.objingElement.getAbstraction();
        Classifier objingClass = this.objingElement.getRealizingClassifier();

...
//            GenerationProperties.getInstance().getReportModel().addWarning(message, internalTransition);
        }
    }
    ...
    private void setEffect() {
        ...
        if ((effect != null) && (!effect.equals(""))){
            ...
            Behavior objBehavior = transition.getBehaviorEffect();
            if (objBehavior != null){
                org.eclipse.uml2.uml.Element behavior = GenerationProperties.getInstance().getMappedElement(objBehavior);
        
                if ((behavior != null) 
                        && (behavior instanceof org.eclipse.uml2.uml. Behavior)){
        
                    this.ecoreBehavior = UMLFactory.eINSTANCE.createOpaqueBehavior();
                    this.ecoreBehavior.getRedefinedBehaviors().add((org.eclipse.uml2.uml.Behavior)behavior);
                }

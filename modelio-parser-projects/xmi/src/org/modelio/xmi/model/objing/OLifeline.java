...
public class OLifeline extends OModelElement {
    ...
    private void setRepresented(org.eclipse.uml2.uml.Lifeline ecoreElt) {
        ...
        Element type = lifeline.getRepresented();
        if (type != null) {
            org.eclipse.uml2.uml.Element temp = GenerationProperties.getInstance().getMappedElement(type);
            if (temp instanceof org.eclipse.uml2.uml.ConnectableElement){
                ecoreElt.setRepresents((org.eclipse.uml2.uml.ConnectableElement)temp);
            }else{
                ...
                String message = Xmi.I18N.getMessage("logFile.warning.unsupportedTypeExport", 
                        ...
                        lifeline.getClass().getName());
                xmiLogs.writelnInLog(message);
//                GenerationProperties.getInstance().getReportModel().addWarning(message, lifeline);
            }

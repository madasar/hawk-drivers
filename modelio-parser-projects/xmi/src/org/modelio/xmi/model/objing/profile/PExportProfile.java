...
public class PExportProfile implements IExportProfileElement {
    ...
    private void attach(final org.eclipse.uml2.uml.Profile ecoreElt) {
        ...
        if (this.objingElt.getOwner() instanceof Profile){
            org.eclipse.uml2.uml.Profile ecoreOwner = (org.eclipse.uml2.uml.Profile) genProp.getMappedElement(this.objingElt.getOwner());
            ecoreOwner.getPackagedElements().add(ecoreElt);
        }else{
        
            Element owner = ProfileUtils.getProfileOwner(this.objingElt);
            org.eclipse.uml2.uml.Profile ecoreOwner = null;
            if ((owner != null) && (owner instanceof Profile)){
                PExportProfile export = new PExportProfile((Profile) owner);
                export.visit();
                ecoreOwner = (org.eclipse.uml2.uml.Profile) genProp.getMappedElement(owner);

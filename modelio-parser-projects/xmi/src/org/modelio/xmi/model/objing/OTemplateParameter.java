...
public class OTemplateParameter extends ONameSpace {
    @objid ("707abb5e-fc69-4a85-adad-46b0a3baea23")
            ...
            if (ecoreOwner instanceof org.eclipse.uml2.uml.TemplateableElement){
                ...
                try{
                    if (this.signature == null){
                        ...
                        ObjingEAnnotation.setDeleted(this.signature, true);
                    }
    ...
    public void attach(org.eclipse.uml2.uml.Element ecoreElt) {
        ...
        if (ecoreOwner instanceof org.eclipse.uml2.uml.TemplateableElement){
            ...
            try{
                if (this.signature == null){
                    this.signature = UMLFactory.eINSTANCE.createTemplateSignature();              
                }
                
                this. signature.getOwnedElements();
                this.signature.getOwnedParameters().add((org.eclipse.uml2.uml.TemplateParameter) ecoreElt);
                ((org.eclipse.uml2.uml.TemplateableElement) ecoreOwner).setOwnedTemplateSignature(this.signature);
...
//                GenerationProperties.getInstance().getReportModel().addWarning(message, getObjingElement());
    ...
    private void setIsValueParameter(org.eclipse.uml2.uml.TemplateParameter ecoreElt) {
        ObjingEAnnotation.setValueParameter(ecoreElt, ((TemplateParameter) getObjingElement()).isIsValueParameter());
    }

...
public class OParameter extends OModelElement {
    ...
    public org.eclipse.uml2.uml.Element createEcoreElt() {
        if (this.objingElement.isStereotyped(XMIProperties.modelerModuleName, IModelerModuleStereotypes.UML2CLASSIFIERTEMPLATEPARAMETER))
            return UMLFactory.eINSTANCE.createClassifierTemplateParameter();
        else if (this.objingElement.isStereotyped(XMIProperties.modelerModuleName, IModelerModuleStereotypes.UML2OPERATIONTEMPLATEPARAMETER))

...
public class OPackage extends ONameSpace {
    ...
    public void attach(org.eclipse.uml2.uml.Element ecoreElt) {
        ...
        if ((objingOwner != null) && (!(objingOwner instanceof Project))) { //else project root
    ...
    private void setInstantiableEAnnotation(org.eclipse.uml2.uml.Package ecoreElt) {
        ObjingEAnnotation.setInstantiable(ecoreElt, ((org.modelio.metamodel.uml.statik.Package)getObjingElement()).isIsInstantiable());
    }

    @objid ("46211b2a-ddee-42ae-8db1-10f963c1aee4")
    private void setLeafEAnnotation(org.eclipse.uml2.uml.Package ecoreElt) {
        ObjingEAnnotation.setLeaf(ecoreElt, ((org.modelio.metamodel.uml.statik.Package)getObjingElement()).isIsLeaf());
    }

    @objid ("bd363dca-7ce5-4d84-b50f-5e94957af4e9")
    private void setRootEAnnotation(org.eclipse.uml2.uml.Package ecoreElt) {
        ObjingEAnnotation.setRoot(ecoreElt, ((org.modelio.metamodel.uml.statik.Package)getObjingElement()).isIsRoot());
    }

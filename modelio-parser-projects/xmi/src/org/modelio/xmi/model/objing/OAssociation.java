...
public class OAssociation extends OModelElement {
    ...
    @objid ("b54a1445-3157-4bf0-bdb7-640d37414ada")
    private Association objingElement = null;

    @objid ("0d9493e6-7d92-47ee-b497-536842e79387")
    @Override
    public org.eclipse.uml2.uml.Element createEcoreElt() {
        if (!this.isIsClassAssociation){
            if (this.objingElement.isStereotyped(XMIProperties.modelerModuleName, IModelerModuleStereotypes.UML2COMMUNICATIONPATH)){
               return UMLFactory.eINSTANCE.createCommunicationPath();
            }else if (this.objingElement.isStereotyped(XMIProperties.modelerModuleName, IModelerModuleStereotypes.UML2EXTENSION)){
    ...
    private void linkEcoreAssociation(org.eclipse.uml2.uml.Association ecoreElt) {
        ...
        for (AssociationEnd assocEnd : this.objingElement.getEnd()) {

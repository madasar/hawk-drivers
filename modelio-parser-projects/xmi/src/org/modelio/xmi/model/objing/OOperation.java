...
public class OOperation extends OFeature {
    ...
    private Operation objingElement = null;
    ...
    private void attachOperation(org.eclipse.uml2.uml.Operation ecoreElt) {
        ...
        if (ecoreOwner != null) {
            ...
            if (objingOwner instanceof Actor
                    ...
                    || objingOwner instanceof Signal) {
                /*
                 * if (ecoreOwner == null) { GenerationProperties genProp =
                 * GenerationProperties.getInstance();
                 * objingOwner.accept(genProp.getIjingVisitor()); ecoreOwner =
                 * (org.eclipse.uml2.uml.Element)revProp.getMappedElement(objingElement.getOwner().getId()); }
                 * if (ecoreOwner != null) { EAnnotation objingEA =

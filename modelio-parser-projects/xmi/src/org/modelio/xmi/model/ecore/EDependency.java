...
public class EDependency extends ENamedElement {
    ...
    public void setProperties(Element objingElt) {
        ...
        if (ObjingEAnnotation.isDestroy(this.ecoreElement) 
            ...
            setFlow((ModelElement) objingElt);
        }
    }
    ...
    private void attachDependency(List<Object> objingElt) {
        ...
        for (Object eClient : clientList) {
            if (eClient instanceof org.eclipse.uml2.uml.NamedElement) {
                ...
                ModelElement objingClient = getObjingEltFromMap(ecoreClient);
                ...
                if (objingClient != null) {
                    for (Object eSupplier : supplierList) {
                        if (eSupplier instanceof org.eclipse.uml2.uml.NamedElement) {
                            ...
                            ModelElement objingSupplier = getObjingEltFromMap(ecoreSupplier);
    ...
    private ModelElement getObjingEltFromMap(final org.eclipse.uml2.uml.NamedElement ecoreClient) {
        ReverseProperties revProp = ReverseProperties.getInstance();
        
        ModelElement objingClient = null;
        ...
        if (objClient instanceof ModelElement) {
            objingClient = (ModelElement) objClient;
        }
        return objingClient;
    }

...
public class EExtend extends ENamedElement {
    ...
    public void attach(Element objingElt) {
        ...
        if (objingTarget != null && objingOrigin != null) {
            ...
            try {
                objingUseCaseDependency.getExtension().add(this.mmservices.getStereotype( XMIProperties.modelerModuleName, 
                        IModelerModuleStereotypes.EXTEND, objingUseCaseDependency.getMClass()));

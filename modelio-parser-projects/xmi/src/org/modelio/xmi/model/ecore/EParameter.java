            ...
            if (defaultValue instanceof InstanceValue){
                ...
                if (spec != null){
                    ...
                    if ((instance != null) && (instance instanceof Instance)) {
                        ...
                        try {
                            ReverseProperties.getInstance().getMModelServices().getModelFactory().createDependency(objingElt, (Instance) instance, XMIProperties.modelerModuleName, IModelerModuleStereotypes.UML2INSTANCEVALUE);
    ...
    private void setType(Parameter objingElt) {
        ...
        if (ecoreType != null) {
            ...
            if (!(( ReverseProperties.getInstance().isRoundtripEnabled()) 
                ...
                objingElt.setType(ReverseProperties.getInstance().getModelioTypes().getUNDEFINED());

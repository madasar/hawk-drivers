...
public class EPackageImport extends EElement {
    ...
    public void attach(Element objingElt) {
        ...
        if  ((model != null)  && revProp.getEcoreModels().contains(model) ){
            ...
            if (objingImported != null){
                ...
                xmilogs.writelnInLog(Xmi.I18N.getMessage("logFile.warning.unimportedElement.importPackage.ownerNull"
                        , ownerName));
                objingElt.delete();
            }
        }else{
    ...
    private void setVisibility(PackageImport objingElt) {
        ...
        default:
            ...
            objingElt.setVisibility(VisibilityMode.PUBLIC);
            XMILogs.getInstance().writelnInLog(Xmi.I18N.getMessage("logFile.warning.wrongVisibility",

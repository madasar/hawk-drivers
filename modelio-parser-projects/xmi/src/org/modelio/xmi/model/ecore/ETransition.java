...
public class ETransition extends ENamedElement {
    ...
    @objid ("941eb4b7-ebb6-4012-b32a-4b026ce6cb9e")
    ...
    private void setTrigger(Transition transition) {
        ...
        if (ecoreTriggerList.size() > 0) {
            ...
            if (ecoreEvent != null){    
        //                if (ecoreEvent instanceof org.eclipse.uml2.uml.SendOperationEvent) {
        //                    setTriggerEvent(transition, (org.eclipse.uml2.uml.SendOperationEvent) ecoreEvent);
        //        
        //                } else 
...
//    @objid ("0ca46ea8-4583-11e0-b54c-00137279a832")
//    private void setTriggerEvent(Transition transition, org.eclipse.uml2.uml.SendOperationEvent ecoreEvent) {
//         org.eclipse.uml2.uml.Operation ecoreOp = ecoreEvent.getOperation();
//        if (ecoreOp != null) {
//            org.eclipse.uml2.uml.StateMachine ecoreSM = EcoreModelNavigation
//                    .getMostEnclosingStateMachine(this.ecoreElement);
//            Object objingSM = ReverseProperties.getInstance().getMappedElement(ecoreSM);
//            Object objingOp = ReverseProperties.getInstance().getMappedElement(ecoreOp);
//
//            if (objingSM instanceof StateMachine
//                    && objingOp instanceof Operation) {
//                Event objingEvent = ReverseProperties.getinstance().getMModelServices().getModelFactory().createEvent();
//                objingEvent.setComposed((StateMachine) objingSM);
...
//
//
//                objingEvent.setCalled((Operation) objingOp);
//            }
//        }
//    }

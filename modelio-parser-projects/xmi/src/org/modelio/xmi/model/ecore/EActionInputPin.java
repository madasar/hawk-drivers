...
public class EActionInputPin extends EInputPin {
    ...
    public Element createObjingElt() {
        ...
        InputPin result = mmServices.getModelFactory()
                .createInputPin();
              
        try {
            result.getExtension().add(mmServices.getStereotype( IModelerModuleStereotypes.UML2ACTIONINPUTPIN, result.getMClass()));

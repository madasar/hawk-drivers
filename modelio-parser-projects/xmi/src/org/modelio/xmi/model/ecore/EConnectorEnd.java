...
public class EConnectorEnd extends EElement {
    ...
    public void attach(Element objingElt) {
        ...
        Object  obOwner = null;
        if (owner != null){
            obOwner = ReverseProperties.getInstance().getMappedElement(owner);
        ...
        if (((ConnectorEnd)objingElt).getOwner() == null){
            ...
            if (this.role != null){
                ...
                obOwner = ReverseProperties.getInstance().getMappedElement(this.role);
                this.part = this.ecoreElement.getPartWithPort(); 
                
                if ((this.part != null) && (this.part.equals(this.role.getOwner()))){
                    
                    Object obPart = ReverseProperties.getInstance().getMappedElement(this.part);
    ...
    private void setIsNavigable(LinkEnd linkEnd) {
        linkEnd.setNavigable(ObjingEAnnotation.isNavigable(this.ecoreElement));
    }

...
public class EComponentRealization extends ENamedElement {
    ...
    public List<Element> createObjingElt() {
        ...
        if (ecoreElt.getRealizingClassifiers() != null){
            ...
            org.eclipse.uml2.uml.Component component = ecoreElt.getAbstraction();
            ...
            if (component != null){
                ...
                if (objComponent instanceof Component){
                    ...
                    for (org.eclipse.uml2.uml.Classifier classifier : ecoreElt.getRealizingClassifiers()){
                        Object objClassifier = ReverseProperties.getInstance().getMappedElement(classifier);
                        if (objClassifier instanceof ModelElement){
                            ComponentRealization realization = ReverseProperties.getInstance().getMModelServices().getModelFactory().createComponentRealization();

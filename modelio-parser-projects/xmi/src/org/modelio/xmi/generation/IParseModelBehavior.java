...
public interface IParseModelBehavior {
    ...
    void visitBpmnBehavior(BpmnBehavior param);
    ...
    @objid ("e5120e33-960f-42ce-975a-576017d46a7a")
    void visitDictionary(Dictionary param);
    ...
    @objid ("10fe4a00-39e5-474e-a97f-33554135c8e3")
    void visitNamespaceUse(NamespaceUse param);
    ...
    @objid ("890bbaf0-7b4f-4d34-bc53-9372884f22cf")
    void visitPropertyValueSet(AnalystPropertyTable param);
    ...
    @objid ("8125dee7-a628-42fd-9f32-d3d984503d24")
    void visitRequirement(Requirement param);

    @objid ("f7ff30e1-1cde-4e68-99b7-adac32a0ad63")
    void visitRequirementContainer(RequirementContainer param);
    ...
    @objid ("a3a2c9f6-5c02-45f8-b050-30c0c7b3e66c")
    void visitTerm(Term param);

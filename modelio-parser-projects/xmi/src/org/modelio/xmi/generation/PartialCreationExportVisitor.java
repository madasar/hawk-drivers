...
public class PartialCreationExportVisitor {
    ...
    @objid ("5febdbef-540a-40fb-a3bb-fdf60b6043a4")
    ...
    private class CreationExportMapper extends DefaultModelVisitor {
        ...
        @objid ("454550b7-649b-47e4-b6e4-14e37a16b6c2")
        @Override
        public Object visitDictionary(Dictionary objingElt) {
            return null;
        }
        ...
        public Object visitLink(Link objingElt) {
            ...
            Element connectorOwner = AbstractObjingModelNavigation.getConnectorOwner(objingElt);
       ...
       //     GenerationProperties.getInstance().getReportModel().addWarning(message, objingElt);
        ...
        @objid ("d7fe205d-e304-456c-bd71-29f128092057")
        @Override
        public Object visitNamespaceUse(NamespaceUse objingElt) {
            return null;
        }
        ...
        @objid ("547e0b0b-867d-4bf7-bb7c-dfdc037c1da8")
        @Override
        public Object visitRequirement(Requirement objingElt) {
            GenerationProperties.getInstance();
            PartialCreationExportVisitor.this.ecoreElt = UMLFactory.eINSTANCE.createClass();
            return null;
        }

        @objid ("3c38e824-4fd0-46c0-b492-373de4d87cfb")
        @Override
        public Object visitRequirementContainer(RequirementContainer objingElt) {
            org.eclipse.uml2.uml.Package result  = UMLFactory.eINSTANCE.createPackage();
        ...
        @objid ("d5f26f3b-66b8-4ae0-93e3-88c522ad68d9")
        @Override
        public Object visitTerm(Term objingElt) {
            return null;
        }

...
public class XMIExportBehavior implements IParseModelBehavior {
    ...
    public XMIExportBehavior() {
        this.exportModel = new ExportModel(null);
    }

    @objid ("ea9190d2-e69a-4c5c-994d-3e6de90d1801")
    public XMIExportBehavior(final IProgressMonitor localMonitor) {
        this.exportModel = new ExportModel(localMonitor);
    }
    ...
    @Override
    public void visitBpmnBehavior(final BpmnBehavior param) {
    ...
    @objid ("72016291-b75d-428e-9cf7-348c151e7662")
    @Override
    public void visitDictionary(final Dictionary param) {
        ODictionary element = new ODictionary(param);
        this.exportModel.export(element);
    }
    ...
    @objid ("3cb12e2e-7e7f-4dd4-885b-e807bcb3a752")
    @Override
    public void visitNamespaceUse(final NamespaceUse param) {
        ONamespaceUse element = new ONamespaceUse(param);
        this.exportModel.export(element);
    }
    ...
    @objid ("1f117a4e-c47d-431d-a2da-2d2408a712f0")
    @Override
    public void visitPropertyValueSet(final AnalystPropertyTable param) {
        OPropertyValueSet element = new OPropertyValueSet(param);
        this.exportModel.export(element);
    }
    ...
    @objid ("484c76e2-00d8-4d00-b451-f455bd95d761")
    @Override
    public void visitRequirement(final Requirement param) {
        ORequirement element = new ORequirement(param);
        this.exportModel.export(element);
    }

    @objid ("2804dcf0-4eec-4c20-95e7-01c48b7a3537")
    @Override
    public void visitRequirementContainer(final RequirementContainer param) {
        ORequirementContainer element = new ORequirementContainer(param);
        this.exportModel.export(element);
    }
    ...
    @objid ("490a0e20-7a66-474b-a809-fa7608b4e42e")
    @Override
    public void visitTerm(final Term param) {
        OTerm element = new OTerm(param);
        this.exportModel.export(element);
    }

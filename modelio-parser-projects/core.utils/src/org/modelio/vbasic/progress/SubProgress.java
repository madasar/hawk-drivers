...
public final class SubProgress implements IModelioProgress {
    ...
    private int consume(final double ticks) {
        if (this.totalParent == 0 || this.totalForChildren == 0) // this monitor has no available work to report
            return 0;
...
/* (non-Javadoc)
     * @see org.eclipse.core.runtime.IModelioProgress#isCanceled()
     */
...
/* (non-Javadoc)
     * @see org.eclipse.core.runtime.IModelioProgress#setTaskName(java.lang.String)
     */
     ...
     * if and only if the SUPPRESS_BEGINTASK flag has been set on this SubProgress
     * instance.
     * 
     ...
     * @see org.eclipse.core.runtime.IModelioProgress#beginTask(java.lang.String, int)
...
/* (non-Javadoc)
    ...
    @objid ("c9941615-a5a3-11e1-aa98-001ec947ccaf")
    protected static boolean eq(final Object o1, final Object o2) {
        if (o1 == null)
            return (o2 == null);
        if (o2 == null)
            return false;
